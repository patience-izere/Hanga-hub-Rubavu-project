        ...
        data.results.forEach(model => {
            ...
            modelItem.innerHTML = `
                <div class="model-thumbnail">
                    <img src="${model.thumbnail_url || '/static/lab/images/default-thumbnail.png'}" 
                         alt="${model.name}" 
                         onerror="this.src='/static/lab/images/default-thumbnail.png'">
                </div>
            ...
            modelItem.addEventListener('click', () => loadModel(model.url));
            modelList.appendChild(modelItem);
        });
    } catch (error) {
        console.error('Error loading model list:', error);
        // Add error notification to the panel
        const modelList = document.getElementById('modelList');
        modelList.innerHTML = `
